...
loop     mov r4,r7
         ...
         mov r4,r6; r4 ün yarısını r6 ya yükledik
         rra r6; r6 nın yarısını bulduk
         add r6,r7; bu kısmı okunduğunda artık r7 nın 4.5 katı r7 ye yüklenmiş oldu
         add #13,r7
         mov r4,r8
         rla r8
         rla r8
         add r6,r8
         sub #13,r8; aslında ısı hassasiyetimiz 3 derece yanı 4.5x3 =13 olarak hesaba kattık.5 i ihmal ettik
